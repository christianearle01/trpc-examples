...
import { CreateMessageParams, DeleteMessageParams } from "../config/types";
...
class MessagesModel extends DatabaseModel {
    ...
    fetchMessagesAndComments = async () => {
        ...
        try{
            ...
            response_data = await this.executeQuery(fetch_user_query) as any;
        }
        catch(error){
            console.log(error);
    ...
    createMessage = async(params: CreateMessageParams, name: string) => {
        ...
        try{
            ...
            let create_message_response = await this.executeQuery(create_message_query) as any;
            ...
            if(insert_id){
                ...
                let { result: [{message_created_at}] } = await this.executeQuery<OkPacketParams>(fetch_message_query) as any;
                response_data = create_message_response as any;
                ...
                /* TODO: convert to applicable React response data */
                ...
                response_data.result = message_data;
            }
        }
        catch(error){
            console.log(error);
    ...
    deleteMessage = async(params: DeleteMessageParams) => {
        ...
        try{
            ...
            response_data = await this.executeQuery(delete_message_query) as any;
        }
        catch(error){
            console.log(error);
            response_data.error = error;
